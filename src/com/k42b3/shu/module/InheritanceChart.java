 ...
 */
public class InheritanceChart extends ModuleAbstract
{
	public String getTitle()
	{
		return "Inheritance Chart";
	}

	public String getDescription()
	{
		return "Shows how deep the inheritance level of each class is";
	}
	...
	public JComponent getComponent(Metric metric, Index index)
	{
		...
		{
			int count = index.getInheritanceDepthByClass(classes.get(i));
