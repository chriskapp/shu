 ...
 */
public class ReferenceChart extends ModuleAbstract
{
	...
	{
		return "Shows how many references exist to a specific class";
	}
	...
	public JComponent getComponent(Metric metric, Index index)
	{
		...
		{
			int count = index.findReferencesByClass(classes.get(i)).size();
